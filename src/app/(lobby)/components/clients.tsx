    ...
    <section id="clients" className="space-y-6">
      ...
      <div
        className={cn(
          ...
          "before:absolute before:left-0 before:top-0 before:z-10 before:h-full before:w-20 before:bg-linear-to-r before:from-background md:before:w-96",
          "after:absolute after:right-0 after:top-0 after:z-10 after:h-full after:w-20 after:bg-linear-to-l after:from-background md:after:w-96"
        )}
      >
        {[...Array(2)].map((_, i) => (
          <div
